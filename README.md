...
<p>Modded interstellar proxy click shift and ` same time to get this ~ it brings u to another tab with the proxy cloaked and teachers cant track u it uses nasa page cloak to fool blocking systems to think this is an education page lmao

proxy code was obfuscated and encrypted to make it harder for schools to block this proxy

obfuscatated and encrypted interstellar proxy to make it 100x harder for schools to reverse enginer this proxy

this website uses cloudflare to protect it self against ddos attacks and uses bot mangement to protect proxy against potential school spyware for geting into the website
